...
export async function listingCardBuild() {
  ...
  <div class="max-w-xs max-h-full min-w-80 p-1 ">
    ...
    <span id="listingDescription" class="mt-16 opacity-100 transition-opacity ease-in-out duration-400 group-hover:opacity-0">${listingData.description}</span><br />
  ...
  <div class="absolute inset-0 p-4 opacity-0 transition-opacity ease-in-out duration-400 group-hover:opacity-100 sm:p-6 lg:p-8">
