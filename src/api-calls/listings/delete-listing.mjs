...
export async function deleteListing(listingId) {
	const errorMessageProfile = document.getElementById('errorMessageProfileListings');
	...
	try {
		...
		if (!response.ok) {
			...
			const errorMessage = errorData.message || 'There was a problem deleting the listing. Please try again.';
